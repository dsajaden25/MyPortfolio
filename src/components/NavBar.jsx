...
const NavBar = () => {
  ...
  return (
    <div className="flex justify-between items-center w-full h-20 text-white px-4 bg-black fixed">
      <div>
        <h1 className="text-4xl font-bold font-signature">Jaden</h1>
      </div>
      ...
      {nav && (<ul className="flex flex-col justify-center items-center top-0
      left-0 absolute w-full h-screen bg-gradient-to-b from-black
